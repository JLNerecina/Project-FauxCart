              ...
              {wishlist.length === 0 ? (
                ...
                <div className="space-y-6">
                  {wishlist.map((product) => (
                    ...
                    >
                      <div className="relative h-20 w-20 flex-shrink-0 overflow-hidden rounded bg-slate-100 flex items-center justify-center p-2">
                        <Image
                          src={product.image}
                          alt={product.title}
                          fill
                      ...
                      <div className="flex flex-1 flex-col">
                        ...
                        <div className="mt-3 flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="rounded border border-slate-200 p-1.5 text-slate-400 hover:bg-slate-50 hover:text-rose-500 transition-colors"
