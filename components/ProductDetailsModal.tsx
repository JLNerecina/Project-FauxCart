        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 pointer-events-none">
            <motion.div
              ...
              className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden pointer-events-auto flex flex-col md:flex-row max-h-[90vh]"
            >
              {/* Image Section */}
              <div className="relative w-full md:w-1/2 bg-slate-100 flex items-center justify-center h-48 sm:h-64 md:h-auto md:min-h-full p-6 md:p-12 mix-blend-multiply shrink-0">
                <button
                  onClick={onClose}
                  className="absolute top-4 left-4 md:hidden p-2 bg-white/80 rounded-full text-slate-500 hover:text-slate-900 z-10"
                >
                  <X className="w-5 h-5" />
                </button>
                <button
                  onClick={() => onToggleWishlist(product)}
                  className="absolute top-4 right-4 p-3 rounded-full bg-white/80 backdrop-blur-sm text-slate-400 hover:text-rose-500 hover:bg-white transition-all shadow-sm z-10"
                >
              ...
              <div className="w-full md:w-1/2 p-6 md:p-10 overflow-y-auto flex flex-col">
                ...
                <div className="space-y-6 flex-1">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-slate-900 mt-4">${product.price.toFixed(2)}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 py-6 border-t border-slate-100">
                    <div className="flex gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium text-slate-500 uppercase tracking-wider mb-1">Availability</p>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium text-slate-500 uppercase tracking-wider mb-1">Warranty</p>
                        <p className="text-sm font-semibold text-slate-900">Standard 1-Year</p>
                      </div>
                    </div>
                  </div>
